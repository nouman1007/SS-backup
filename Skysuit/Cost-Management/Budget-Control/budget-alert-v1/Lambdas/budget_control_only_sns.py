  ...
  for linked_account in linked_account_ids :
    if linked_account in account_list:
      ...
      # if dest_org_id:
        ...
        message = "Budget Threshold reached for account {}, has reached 80%, when it will be reached 100% of budget threshold the account will be restricted to create new resources, in oder  to prevent incurring additional charges".format(
            linked_account)
